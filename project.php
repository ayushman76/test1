...
<html lang="en">
	<head>
	    ...
	    <title>Programming Aashram - Javascript Interview Question | PHP Interview Question | HTML Interview Question | Color Plates</title>
	...
	<body>
		...
		<div class="p-3 mb-4">
			<ul class="pagination justify-content-center">
				...
				<li class="page-item">
					<a href="project.php" class="page-link text-danger font-18">7</a>
				</li>
				<li class="page-item">
