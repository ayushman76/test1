...
<html lang="en">
	...
	<body>
		...
		<?php
			include("include/interviewmenu.php");
		?>
			<!--NAV-->
		 ...
		 <div class="tab-content">
			<!--MY QUESTION ARTICLE---> 
			<article id="interview" class="page tab-pane active">
			    <div class="container">
				    <div class="row">
			...
			<article id="HTML"  class="page tab-pane">
			    <div class="container">
				    <div class="row">
					    <div class="head text-center">
			...
			<article id="PHP"  class="page tab-pane">
			    <div class="container">
				    <div class="row">
					    <div class="head text-center">
			...
			<article id="python"  class="page tab-pane">
			    <div class="container">
				    <div class="row">
					    <div class="head text-center">
						   <i class="fab fa-python"></i>
					       <h1 class="text-center p-3">Python Interview Question</h1>
						</div>
					</div>
				<div>
			</article>
		...
		<div class="p-3 mb-4">
			<ul class="pagination justify-content-center">
				...
				<li class="page-item">
					<a href="interview.php" class="page-link   text-danger font-18">4</a>
				</li>
				<li class="page-item">
